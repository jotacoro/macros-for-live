...
/*
     Docs here: https://www.autohotkey.com/boards/viewtopic.php?f=76&t=49980&p=387886#p387886
*/

sonarworksExe := "Reference 4 Systemwide.exe"
audioOutput := "MONITOR L/R (2- Volt 276)" ;Set here your audio output

if (PID := ProcessExist(sonarworksExe)) {
    ProcessClose PID
	ProcessWaitClose(PID)
	AudioDeviceList := EnumAudioEndpoints()
	SetDefaultEndpoint(GetDeviceID(AudioDeviceList, audioOutput))
	ExitApp
	}
else {
    ExitApp
